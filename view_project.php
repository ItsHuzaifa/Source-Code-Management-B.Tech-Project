...
<div class="col-lg-12">
			...
			<div class="callout callout-info">
				<div class="col-md-12">
					<div class="row">
						<div class="col-sm-6">
							<dl>
								<dt><b class="border-bottom border-primary">Repository Name</b></dt>
								...
								//running okay
								$select_FromUser = "SELECT avatar FROM user_productivity WHERE project_id = $id ORDER BY id DESC LIMIT 0, 1";


								$select_form_projectList = "SELECT avatar FROM project_list WHERE id = $id";
								...
								?>
									...
									<?php
									$result = mysqli_query($conn, $select_FromUser);
									if (mysqli_num_rows($result) > 0) {
										while ($the_real_data = mysqli_fetch_assoc($result)) {
											echo "<b>" . preg_replace('/[0-9_]+/', '', $the_real_data['avatar']) . "</b><br>";
											$filename = $the_real_data['avatar'];
										}

										echo "	<a href='assets/uploads/$filename' class=\"text-dark\"> <b>Click here to Download ZIP File </b></a> ";
									} 
									
									else  
									{

										$result2 = mysqli_query($conn, $select_form_projectList);
										if (mysqli_num_rows($result2) > 0) {
											while ($the_real_data2 = mysqli_fetch_assoc($result2)) {
												echo "<b>" . preg_replace('/[0-9_]+/', '', $the_real_data2['avatar']) . "</b><br>";
												$filename = $the_real_data2['avatar'];
											}
										}
						...
						<div class="col-md-6">
							...
							<dl>
								<dt><b class="border-bottom border-primary">Faculty(Project Head)</b></dt>
								<dd>
		...
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Students(Team Member):</b></span>
			...
			<div class="card card-outline card-primary">
				<div class="card-header">
					...
					<?php if ($_SESSION['login_type'] != 3) : ?>
						<div class="card-tools">
							<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_task"><i class="fa fa-plus"></i>Assign Task</button>
						</div>
					<?php endif; ?>
				</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Students Progress/Activity</b>
					<div class="card-tools">
					
					<?php if($_SESSION['login_type'] == 3): ?>

		<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> Commit/Create Branches & Request</button>
