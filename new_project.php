			...
			<form action="" id="manage-project">
				...
				<div class="row">
					<?php if ($_SESSION['login_type'] == 1) : ?>
						<div class="col-md-6">
							<div class="form-group">
								<label for="" class="control-label">faculty(Project Head)</label>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Students(Project Team Members)</label>
				...
				<div class="form-group">
					<label for="" class="control-label">Upload Repositories</label>
					<div class="custom-file">
						<input type="file" class="custom-file-input" id="customFile" name="file" onchange="displayImg(this,$(this))">
